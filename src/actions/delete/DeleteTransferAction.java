...
public class DeleteTransferAction extends ActionSupport implements SessionAware {
    ...
    public String execute() {
        if (ServiceUtil.getLoginService().isLogined(userSession)) {
            if (userSession.get("position").equals("Администратор") ||
                ...
                answer = ServiceUtil.getDeleteService().tryDelete(data, userSession, Transfer.class);
                return SUCCESS;
            }
        }
        answer = "Нет доступа.";
